...
function callback($buffer)
{
    ...
    $buffer = str_replace('src="https://www.pastemagazine.com/wp-content/uploads/', 'src="' . $homeURL . '/wp-content/uploads/', $buffer);
    $buffer = str_replace('srcset="https://www.pastemagazine.com/wp-content/uploads/', 'srcset="' . $homeURL . '/wp-content/uploads/', $buffer);

    $buffer = str_replace('src="https://cdn.pastemagazine.com/wp-content/uploads/', 'src="' . $homeURL . '/wp-content/uploads/', $buffer);
    $buffer = str_replace('srcset="https://cdn.pastemagazine.com/wp-content/uploads/', 'srcset="' . $homeURL . '/wp-content/uploads/', $buffer);
...
function pm_deregister_main_scripts()
{
    // Deregister MailChimp from loading regularly
    wp_deregister_script('mc4wp-forms-api');
    wp_dequeue_script('mc4wp-forms-api');
}
add_action('wp_print_scripts', 'pm_deregister_main_scripts', 100);
