                    ...
                    <div class="large-auto medium-auto small-auto">
                        ...
                        <article id="article-detail-container" <?php //echo $isNoisetrade ? 'class="noisetrade"' : ''; 
                            ...
                            <div
                                ...
                                <div id="detail-main-video" class="responsive-embed widescreen" style="background-image: url('https://i3.ytimg.com/vi/<?php echo $ytID; ?>/maxresdefault.jpg'); background-color: #000000; background-size: cover;background-position: center"
                                    data-artist="<?php echo $artistLabel; ?>">
                                    <iframe style="background-color:transparent;" id="youtube_player"
                                        frameborder="0" allowfullscreen="1" allow="autoplay; encrypted-media"> </iframe>
                                    <script>
                                    setTimeout(function() {
                            ...
                            <div class="header" data-entry-id="<?php the_ID(); ?>" <?php echo !$isMobile ? 'style="height:171px"' : ''; ?>>
                            ...
                            <div class="grid-x article-shares-links four" <?php echo !$isMobile ? 'style="height:38px"' : ''; ?>>
                            ...
                            ?>
                            <div class="main-image" <?php echo !$isMobile ? "style='width: 226px; height: 127px; overflow: hidden;'" : ""?>>
                                <img src="<?php echo $featuredURL; ?>" alt="<?php echo wp_strip_all_tags($title); ?>" width="<?php echo $imgWidth;?>" height="<?php echo $imgHeight;?>"/>
                            </div>
                            <script>
                            jQuery(function($){ 
                                setTimeout(function(){ 
                                    $('.header, .main-image, .article-shares-links').removeAttr('style');
                                }, 1);
                            });
                            </script>
                            <?php } ?>
