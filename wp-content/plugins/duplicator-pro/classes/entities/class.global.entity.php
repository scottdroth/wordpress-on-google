...
class DUP_PRO_Global_Entity extends AbstractEntitySingleton
{
    ...
    /** @var int[] */
    public $manual_mode_storage_ids = [ -2 ];
    //LICENSING
    public $license_status              = Duplicator\Addons\ProBase\License\License::STATUS_UNKNOWN;
    ...
    //PROFILES
    public $profile_idea                = false;
    public $profile_beta                = false;
    public $dupHidePackagesGiftFeatures = !DUPLICATOR_PRO_GIFT_THIS_RELEASE;
    ...
    public function __wakeup()
    {
        ...
        foreach ($this->packageMysqldumpOptions as $index => $data) {
            $this->packageMysqldumpOptions[$index] = GroupOptions::getObjectFromArray($data);
        ...
        try {
            $result = $this->reset(
                [
                    ...
                    'license_type',
                    'license_limit',
                    'last_edd_api_response',
                    'last_edd_api_timestamp',
     ...
     * @return void
     */
    public function setFromData(self $global_data)
    {
