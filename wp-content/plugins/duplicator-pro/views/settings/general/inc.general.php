            ...
            <td>
                ...
                <p class="description">
                    ...
                    <i 
                        ...
                        data-tooltip="<?php DUP_PRO_U::esc_attr_e('Resets standard settings to defaults. Does not affect license key, storage or schedules.'); ?>"
                    >
                    </i>
                </p>
            </td>
...
$msg_ajax_error                 = new DUP_PRO_UI_Messages(DUP_PRO_U::__('AJAX ERROR!') . '<br>' . __('Ajax request error', 'duplicator-pro'), DUP_PRO_UI_Messages::ERROR);
