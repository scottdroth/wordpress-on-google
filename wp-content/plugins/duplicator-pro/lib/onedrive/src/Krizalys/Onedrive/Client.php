...
class Client
{
    ...
    {
        return (int)$this->_state->token->obtained
     ...
     * @return object|string The response body, if any.
     */
    public function apiPut($path, $stream, $pheaders = [],  $size = null, $contentType = null)
    {
        $api = $this->api_url;
    ...
    public function uploadFileChunk(
        ...
        while (!$completed && ($time_passed < $max_worker_time)) {
            ...
            // error_log("## UploadOffset:" . $fileOffset);
